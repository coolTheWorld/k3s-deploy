...
# 安装
INSTALL_K3S_SKIP_DOWNLOAD=true K3S_TOKEN="${K3S_TOKEN}" INSTALL_K3S_EXEC="server --server https://${MASTER_SERVER_IP}:6443 --embedded-registry --disable traefik" ./install_k3s.sh 
# 检查服务状态
